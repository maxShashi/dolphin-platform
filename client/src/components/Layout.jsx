...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#070B1A' }}>
      ...
      {/* Sidebar */}
      <aside
        className="fixed left-0 top-0 h-screen w-[240px] z-30 pt-16 flex flex-col"
        style={{
      ...
      {/* Main content */}
      <main
        className="relative z-10 min-h-screen page-enter"
        style={{ marginLeft: '240px', padding: '88px 32px 32px' }}
      >
        <Outlet />
      </main>
